...
def start():
    ...
    def hesap1():
        ...
        cevap = messagebox.askquestion("Grafiksel Görünüm","Grafisel bir görüntü istermisiniz?")
        ...
        if (cevap == "yes"):
            ...
            bye = Label(pencere2,bg="green",fg="white",text="İyi Günler")
            bye.grid(column=2,row=7)
            bye.config(width=18,height=3)
            time.sleep()
            pencere2.destroy(1)
